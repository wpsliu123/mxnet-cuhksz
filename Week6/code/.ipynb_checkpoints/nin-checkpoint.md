...
![左图是AlexNet和VGG的网络结构，右图是NiN的网络结构。](./nin.svg)
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "training on gpu(3)\nepoch 1, loss 2.2595, train acc 0.159, test acc 0.172, time 68.5 sec\nepoch 2, loss 1.5064, train acc 0.491, test acc 0.633, time 67.7 sec\nepoch 3, loss 0.8793, train acc 0.674, test acc 0.797, time 66.0 sec\nepoch 4, loss 0.5450, train acc 0.799, test acc 0.841, time 65.8 sec\nepoch 5, loss 0.4683, train acc 0.829, test acc 0.820, time 64.2 sec\n"
 }
]
```
