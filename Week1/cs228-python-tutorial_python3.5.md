...
```{.python .input  n=1}
# The following is a interative dichotomoy algorithm
def quicksort(arr):
    if len(arr) <= 1:
        return arr
    pivot = arr[len(arr) // 2]
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "Python 3.6.5 :: Anaconda, Inc.\r\n"
 }
]
```
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "dict_items([('cat', 'cute'), ('dog', 'furry')])\ndict_keys(['cat', 'dog'])\ncute\nTrue\n"
 }
]
```
...
```{.python .input  n=81}
# Matrix / vector product; both produce the rank 1 array [29 67], X*v^T
print(x.dot(v))
print(np.dot(x, v))
```
...
[
 {
  "data": {
   "text/plain": "[<matplotlib.lines.Line2D at 0x7f7f5ffce748>]"
  },
  "execution_count": 101,
  "metadata": {},
...
[
 {
  "data": {
   "text/plain": "<matplotlib.legend.Legend at 0x7f7f5ff68be0>"
  },
  "execution_count": 102,
  "metadata": {},
  "output_type": "execute_result"
